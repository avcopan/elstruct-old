"""
Set of functions to write large scale batches of jobs.
grab_structures   : parses structure file from ANL paper;
                    returns info needed to write jobs
set_build_options :
write_input_file  :
"""
...
def write_input_file(name, mult, coords, template_name, augbasis, densityfit):
    ...
    # Obtain name of template corresponding to requested elec. structure job
    ...
    with open('input.dat', "w") as inputfile:
        inputfile.write(subbed_template)
