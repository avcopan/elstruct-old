...
WORK_PATH = os.getcwd()
INIT_GEOM_PATH = os.path.join(WORK_PATH, 'water_init.xyz')
...
INPUT_STR = writer.opt_and_harm_freq(PROGRAM, INPUT_FILE_NAME, METHOD, BASIS,
...
iohelp.write_energy('water_opt', ENERGY)
iohelp.write_cartesian_geometry('water_opt', GEOM)
iohelp.write_harmonic_frequencies('water_opt', FREQS)
iohelp.write_harmonic_zero_point_vibrational_energy('water_opt', ZPVE)
